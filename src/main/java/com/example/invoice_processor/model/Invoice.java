...
@XmlAccessorType(XmlAccessType.FIELD)  // Alanlara göre eşle
public class Invoice {

    @XmlElement(name = "InvoiceNumber")
    private String invoiceNumber;

    // LocalDate doğrudan XML olarak gelmeyeceği için String olarak tutup sonra dönüştüreceğiz.
    ...
    // JAXB için boş constructor olmalı
    public Invoice() {
    }
    ...
    // LocalDate olarak dönüşüm burada
